...
departmentsProduct={'Отдел огнеупор':{
                        'metrick':{'План/факт продаж':['ЛОМ','Неликвид'],
                                   '⁠Количество новых клиентов':['self'],
                                   'Количество успешных креативных решений':['self'],
                                   'Количество холодных звонков':['self'],
                                   'Количество новых объектов':['ЛОМ','Неликвид'],
                                #    'Продажа невостребованного':['self']
                                   }},
                    
                    'Отдел стекло':{
                        'metrick':{'План/факт продаж':['ЭРКЛЕЗ','ЩЕБЕНЬ','ШАРИКИ'],
                                   'Количество новых клиентов/партнеров':['НОВЫЕ','ПОВТОРНЫЕ'],
                                   'Количество холодных звонков':['self'],
                                   '⁠Количество новых рынков':['self'],
                                   'Количество успешных креативных решений':['self']}},
                    
                    'Отдел оборудование':{
                        'metrick':{'План/факт продаж':['self'],
                                   '⁠Количество новых клиентов':['self'],
                                   'Количество новых объектов':['self'],
                                   'Количество холодных звонков':['self'],
                                   'Количество успешных креативных решений':['self'],
                                   }},
                    ...
                    'Отдел демонтаж':{
                        'metrick':{'Улучшение способов демонтажа':['self'],
                                   '% эффективности по срокам':['self'],
                                   'Повышение маржинальности проектов':['self'],
                                   '⁠Количество новых объектов':['self'],
                                   '⁠Экономия на креативности (в рублях)':['self'],
                                   }},
                    
                    'Отдел проектирования и изготовления оборудования':{
                        'metrick':{'Количество холодных звонков':['Проектирование оборудования','Изготовление оборудования'],
