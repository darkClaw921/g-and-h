...
departments =  ['Отдел огнеупор','Отдел стекло','Отдел оборудование','Отдел демонтаж','Отдел проектирования и изготовления оборудования', 'Отдел HR']
...
departmentsProduct={'Отдел огнеупор':{
                        'metrick':{
                                ...
                                #    'Количество успешных креативных решений':['Основное'],
                                   'Количество лояльных клиентов из нелояльных':['Основное'],
                    ...
                    'Отдел стекло':{
                        'metrick':{
                                ...
                                #    'Количество новых клиентов/партнеров':['НОВЫЕ','ПОВТОРНЫЕ'],
                                    ...
                                    'План/факт продаж':['Обработанное','Менеджер 1','Менеджер 2','Менеджер 3'],
                                   'Количество новых клиентов/партнеров':['Менеджер 1','Менеджер 2','Менеджер 3'],
                                   'Количество холодных звонков':['Основное'],
                    ...
                    'Отдел HR':{
                        'metrick':{
                                    # '<--Выбрать-->':['Основное'],
                            'Нанятые/адаптированные сотрудники':['Основное'],
                                   'Проведённое обучение сотрудников':['Основное'],
                                   'Количество разработанных/отредактированных документов':['Основное'],
                                   'Количество растущих статистик':['Основное'],
                                   'Количество креативных решений':['Основное'],
                                   }},
